defmodule Ockam.Kafka.Interceptor.Protocol.Metadata.Response.Parser do
  ...
  def parse_brokers(api_version, data) when api_version < 9 do
    BaseParser.parse_type({:array, fn data -> parse_broker(api_version, data) end}, data)
  end

  def parse_brokers(api_version, data)
  ...
  def parse_topics(api_version, data) when api_version < 9 do
    BaseParser.parse_type({:array, fn data -> parse_topic(api_version, data) end}, data)
  end

  def parse_topics(api_version, data)
      when api_version >= 9 and api_version <= 12 do
    BaseParser.parse_type(
  ...
  def parse_partitions(api_version, data) when api_version < 9 do
    BaseParser.parse_type(
  ...
  def parse_partitions(api_version, data)
      when api_version >= 9 and api_version <= 12 do
    BaseParser.parse_type(
  ...
  def parse_broker(v1_8, data) when v1_8 >= 1 and v1_8 <= 8 do
    with {:ok, node_id, rest} <- BaseParser.parse_type(:int32, data),
         {:ok, host, rest} <- BaseParser.parse_type(:string, rest),
  ...
  def parse_broker(v9_12, data) when v9_12 >= 9 and v9_12 <= 12 do
    with {:ok, node_id, rest} <- BaseParser.parse_type(:int32, data),
  ...
  def parse_topic(0 = api_version, data) do
  ...
  def parse_topic(v1_7 = api_version, data) when v1_7 >= 1 and v1_7 <= 7 do
    with {:ok, error_code, rest} <- BaseParser.parse_type(:int16, data),
         {:ok, name, rest} <- BaseParser.parse_type(:string, rest),
  ...
  def parse_topic(8 = api_version, data) do
    with {:ok, error_code, rest} <- BaseParser.parse_type(:int16, data),
         {:ok, name, rest} <- BaseParser.parse_type(:string, rest),
         {:ok, is_internal, rest} <- BaseParser.parse_type(:boolean, rest),
  ...
  def parse_topic(9 = api_version, data) do
    with {:ok, error_code, rest} <- BaseParser.parse_type(:int16, data),
  ...
  def parse_topic(v10_11 = api_version, data)
  ...
  def parse_topic(12 = api_version, data) do
    with {:ok, error_code, rest} <- BaseParser.parse_type(:int16, data),
