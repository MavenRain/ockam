defmodule Ockam.Kafka.Interceptor.Protocol.Metadata.Response.Formatter do
  ...
  def format_broker(0, %Broker{node_id: node_id, host: host, port: port}) do
    BaseFormatter.format_typed_list([
      {:int32, node_id},
      {:string, host},
      {:int32, port}
  ...
  def format_broker(v1_8, %Broker{node_id: node_id, host: host, port: port, rack: rack})
  ...
  def format_broker(v9_12, %Broker{
        node_id: node_id,
        host: host,
        port: port,
        rack: rack,
  ...
  def format_topic(0 = api_version, %Topic{
  ...
  def format_topic(v1_7 = api_version, %Topic{
        error_code: error_code,
        name: name,
  ...
  def format_topic(8 = api_version, %Topic{
        error_code: error_code,
        name: name,
        is_internal: is_internal,
        partitions: partitions,
  ...
  def format_topic(9 = api_version, %Topic{
        error_code: error_code,
        name: name,
        is_internal: is_internal,
        partitions: partitions,
  ...
  def format_topic(v10_11 = api_version, %Topic{
        error_code: error_code,
        name: name,
        topic_id: topic_id,
        is_internal: is_internal,
  ...
  def format_topic(12 = api_version, %Topic{
        error_code: error_code,
        name: name,
        topic_id: topic_id,
        is_internal: is_internal,
